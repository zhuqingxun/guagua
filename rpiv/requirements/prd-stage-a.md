...
**结论（5/5 已下单事实）**：
- 主商品 SKU = **PI3B+ 整机版** ¥5000（爱折腾商品页公开 SKU 之一；用户原话"针对标准版做的优化"指的是 vs 默认 PI52G 标准版做的主控降版+配套增强）
...
**Pi 3B+ ¥5000 比 Pi 5 PI52G ¥4199 反而贵 ¥801** —— 解释路径：
- Pi 3B+ 在国内现货稳定，Pi 5 紧缺/不稳；
- 爱折腾对 Pi 3B+ 做了更多配套优化（3D 件改造 / 电源管理 / 适配 BNO055 + ST3215 控制板）；
- 待用户提供卖家旺旺聊天记录最终澄清。

**用户主动选 Pi 3B+ 而非 PI52G**：知情决定，应有具体理由（待聊天记录揭晓，可能是稳定性 / py-xiaozhi 兼容性 / sim2real 算力刚好够）。
