...
| 来源 | **爱折腾智能机器人**（淘宝 id=946801761316，店铺 4.7 分）| 27 篇 ncnynl 教程作者直接背书 |
...
### 4.2 实购 SKU：PI3B+ 整机版定制 + 小智语音附件（2026-05-05 实付 ¥5247.40）

**结论（5/5 已下单事实）**：
- 主商品 SKU = **PI3B+ 整机版** ¥5000（与卖家私下定制，商品页公开 10 SKU 不含此选项；爱折腾"针对标准版做的优化"）
- 附件 SKU = **实战派小智语音交互** ¥250（py-xiaozhi 物理 IO 套件，与 System 2 S0 阶段强绑定）
- 实付 ¥5247.40（订单号 3299974573941008764，2026-05-05 16:35 下单，后天 16:36 前发货）
- M2 决策门下单时机已 partial bypassed，详见 m2-purchase-decision.md「5/5 用户已先行下单」段

**比 PRD 原假设标准版 ¥4199 多 ¥1048**，主要贡献：
- Pi 3B+ 主控升级（vs Pi Zero 2W）≈ +¥800-1000（含 SD 卡升级 + 适配 3D 件）
- 小智语音附件 ¥250
...
|------|------------|-----------------|-----|
| 主控 | Jetson Orin Nano 8GB | **Pi 3B+（阶段 A，5/5 实购升级）→ Orin Nano（阶段 B）** | 上游 apirrone 默认 Pi Zero 2W，爱折腾"针对标准版优化"换主控为 Pi 3B+；A53 同内核 1.4GHz 推理预期更快 |
